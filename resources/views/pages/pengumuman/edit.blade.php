    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                {!! Form::open(['route' => ['pengumuman.update', $pengumuman->id], 'id' => 'form-pengumuman']) !!}
                @method('PUT')
                <div class="form-group">
                    <label for="judul">Judul</label>
                    {!! Form::text('judul', $pengumuman->judul, ['class' => 'form-control', 'placeholder' => 'Judul pengumuman', 'required']) !!}
                </div>
                <div class="form-group">
                    <label for="konten">Isi / Konten</label>
                    {!! Form::textarea('konten', $pengumuman->konten, ['class' => 'summernote text-black']) !!}
                </div>
                <div class="form-group">
